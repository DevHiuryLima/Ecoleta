...
// Sempre que cria um estado para um array ou objeto a gente precisa manualmente informa
// o tipo da variavel que vai ser informada ali dentro
import './styles.css';
...
const CreatePoint = () => {
   ...
   function handleSelectCity(event: ChangeEvent<HTMLSelectElement>){
    ...
    async function handleSubmit(event: FormEvent){
        ...
        //criando o ponto de coleta na api
